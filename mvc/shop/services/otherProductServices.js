var q = require("q");
var productModels = require("../model/otherProductModel");

function otherProductServices() {
  ...
  function UpdateProducts(condition, data) {
    var deferred = q.defer();
    productModels
      .findOneAndUpdate(condition, { $set: data }, { useFindAndModify: false })
      .then(function (result) {
        var resp = {
          success: true,
...
module.exports = otherProductServices();
