...
module.exports = {
  ...
  updateValidation: Yup.object({
    ...
    personaldetails: Yup.object({
      height: Yup.number().required("No height provided.").min(3,"invalid height provided").max(12,"invalid height provided"),
      eventsAttended: Yup.number().min(0,"invalid height provided").max(99999,"invalid height provided").required("add 0 if no event attended"),
